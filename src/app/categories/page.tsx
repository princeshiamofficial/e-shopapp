...
export default function CategoriesPage() {
  ...
  return (
    ...
    <div className="w-full lg:grid lg:grid-cols-[4.75rem_1fr] lg:bg-[#FCFCFC] min-h-screen">
        ...
        <div data-id="content-wrapper-root"
            ...
            <div className="relative min-h-screen flex flex-col w-full lg:bg-bg-fill overflow-x-clip">
